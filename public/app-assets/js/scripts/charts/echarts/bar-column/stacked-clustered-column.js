/*=========================================================================================
    File Name: maoqe3ed-clustered-column.js
    Description: echarts maoqe3ed clustered column chart
    ----------------------------------------------------------------------------------------
...
// maoqe3ed clustered column chart
// ------------------------------
...
$(window).on("load", function(){
    ...
    require(
        ...
        function (ec) {
            // Initialize chart
            // ------------------------------
            var myChart = ec.init(document.getElementById('maoqe3ed-clustered-column'));
